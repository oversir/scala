...
$c_Lcalculator_Calculator$.prototype.lookup__p1__T__sci_Map__Lcalculator_Expr = (function(name, refs) {
  var this$1 = refs.get__O__s_Option(name);
  if (this$1.isEmpty__Z()) {
    var jsx$1 = new $c_Lcalculator_Literal().init___D((NaN))
  } else {
    var arg1 = this$1.get__O();
    var x$1 = $as_Lcalculator_Signal(arg1);
    var jsx$1 = $as_Lcalculator_Expr(x$1.apply__O())
  };
  return $as_Lcalculator_Expr(jsx$1)
});
$c_Lcalculator_Calculator$.prototype.computeValues__sci_Map__sci_Map = (function(exprs) {
  var f = new $c_Lcalculator_Calculator$$anonfun$computeValues$1().init___sci_Map(exprs);
  return new $c_sci_MapLike$$anon$2().init___sci_MapLike__F1(exprs, f)
});
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, refs) {
  _eval: while (true) {
    var x1 = expr;
    ...
    if ($is_Lcalculator_Ref(x1)) {
      ...
      var name = x3.name$2;
      if ((name !== null)) {
        var temp$expr = this.lookup__p1__T__sci_Map__Lcalculator_Expr(name, refs);
        var temp$refs = $as_sci_Map(refs.$$minus__O__sc_Map(name));
        expr = temp$expr;
        refs = temp$refs;
        continue _eval
      }
    ...
    if ($is_Lcalculator_Plus(x1)) {
      ...
      if ((a !== null)) {
        if ((b !== null)) {
          return (this.eval__Lcalculator_Expr__sci_Map__D(a, refs) + this.eval__Lcalculator_Expr__sci_Map__D(b, refs))
        }
      }
    };
    if ($is_Lcalculator_Minus(x1)) {
      ...
      if ((a$2 !== null)) {
        if ((b$2 !== null)) {
          return (this.eval__Lcalculator_Expr__sci_Map__D(a$2, refs) - this.eval__Lcalculator_Expr__sci_Map__D(b$2, refs))
        }
      }
    };
    if ($is_Lcalculator_Times(x1)) {
      ...
      if ((a$3 !== null)) {
        if ((b$3 !== null)) {
          return (this.eval__Lcalculator_Expr__sci_Map__D(a$3, refs) * this.eval__Lcalculator_Expr__sci_Map__D(b$3, refs))
        }
      }
    };
    if ($is_Lcalculator_Divide(x1)) {
      ...
      if ((a$4 !== null)) {
        if ((b$4 !== null)) {
          return (this.eval__Lcalculator_Expr__sci_Map__D(a$4, refs) / this.eval__Lcalculator_Expr__sci_Map__D(b$4, refs))
        }
      }
    };
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(b$2, delta$1) {
    return (function() {
      if (($uD(delta$1.apply__O()) > 0)) {
        var jsx$3 = $uD(b$2.apply__O());
        var x = $uD(delta$1.apply__O());
        var jsx$2 = $uD($g["Math"]["sqrt"](x));
        var jsx$1 = $uD(b$2.apply__O());
        var x$1 = $uD(delta$1.apply__O());
        var array = [(((-jsx$3) + jsx$2) / 2), (((-jsx$1) - $uD($g["Math"]["sqrt"](x$1))) / 2)];
        if (($uI(array["length"]) === 0)) {
          ...
          var jsx$4 = $as_sc_GenTraversable(b$1.elems$1)
        };
        return $as_sci_Set(jsx$4)
      } else if (($uD(delta$1.apply__O()) === 0)) {
        var array$1 = [((-$uD(b$2.apply__O())) / 2)];
        if (($uI(array$1["length"]) === 0)) {
          ...
          var jsx$5 = $as_sc_GenTraversable(b$3.elems$1)
        };
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      ...
      switch (x1) {
        default:
          return ((x1 >= 15) ? "green" : ((x1 < 0) ? "red" : "orange"));
      }
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.init___sci_Map = (function(exprs$1) {
  this.exprs$1$f = exprs$1;
  return this
});
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__Lcalculator_Signal__Lcalculator_Signal = (function(expr) {
  ...
  var expr$2 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, expr$1) {
    return (function() {
      return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(expr$1.apply__O()), arg$outer.exprs$1$f)
    })
  })(this, expr));
